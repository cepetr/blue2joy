...
// Checks if the given message is a synchronization request that should trigger session start.
bool btjp_is_sync_request(const uint8_t *inbuff, size_t insize);
