  ...
  override willUpdate(changed: any) {
    if (changed.has("profileId") || changed.has("intgId")) {
      if (this.profileId !== undefined && this.intgId !== undefined) {
        this._local =
          btj.profiles.get(this.profileId)?.intgs.get(this.intgId) ??
          Btj.IntgConfig.default();
      }
    }
  }
  ...
  private renderMode() {
    ...
    return html`
      <div class="mb-2">
        ...
        >
          <option value="0" ?selected=${cfg.mode === Btj.IntgMode.RELATIVE}>
            Relative
          </option>
          <option value="1" ?selected=${cfg.mode === Btj.IntgMode.ABSOLUTE}>
            Absolute
          </option>
        </select>
      </div>
          ...
          <div class="col">
            <div class="card-body py-2">
              <div class="row g-4">
                ...
                <div class="col-6 col-xl-2">
                  ${usageType != "" && mode === Btj.IntgMode.ABSOLUTE
                    ? this.renderDeadZone()
                    : ""}
                </div>
                <div class="col-6 col-xl-2">
